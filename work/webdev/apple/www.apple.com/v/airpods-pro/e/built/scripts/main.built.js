! function() {
    ...
    3: [function(e, t, r) {
        ...
        var i = e("@marcom/ac-shared-instance").SharedInstance,
            ...
            p = (e("@marcom/ac-event-emitter").EventEmitter, "ac-breakpoints-delegate:BreakpointsDelegate"),
            c = "2.1.1",
            u = "breakpoint",
    ...
    5: [function(e, t, r) {
        ...
        i = n.prototype, i.on = function() {
            ...
            if (this._delegateFuncs[t] && this._delegateFuncs[t][e]) {
                ...
                for (o = 0; o < p; o++)
                    if (s = this._delegateFuncs[t][e][o], i && "undefined" == typeof r && (r = s.func), s.func === r && s.context === n) {
                        a = o;
                        break
                    }
            }
            ...
            var i, a = n.length;
            for (i = 0; i < a; i++) p.dispatchEvent(n[i], e, {
                bubbles: !0,
                cancelable: !0,
                detail: t
            })
    ...
    7: [function(e, t, r) {
        ...
        "./shared/getEventType": 11,
        "./utils/addEventListener": 14
    }],
    8: [function(e, t, r) {
        "use strict";
    ...
    39: [function(e, t, r) {
        (function(t) {
            ...
            r.Buffer = o, r.SlowBuffer = d, r.INSPECT_MAX_BYTES = 50, o.TYPED_ARRAY_SUPPORT = void 0 !== t.TYPED_ARRAY_SUPPORT ? t.TYPED_ARRAY_SUPPORT : n(), r.kMaxLength = i(), o.poolSize = 8192, o._augment = function(e) {
                ...
                for (var a = i - n, s = r - t, p = Math.min(a, s), c = this.slice(n, i), u = e.slice(t, r), g = 0; g < p; ++g)
                    if (c[g] !== u[g]) {
                        a = c[g], s = u[g];
                        break
                    }
    ...
    72: [function(e, t, r) {
        ...
        }, m.setTexture = function(e, t) {}, m.getCurrentBreakpointName = function() {
    ...
    73: [function(e, t, r) {
        ...
        n = p.prototype = Object.create(i.prototype), n.createTexture = function(e, t, r) {
            ...
            var t = e.width,
                r = e.height;
            return e instanceof HTMLVideoElement && (t = e.videoWidth, r = e.videoHeight), {
                width: t,
                height: r
            }
        }, n.destroy = function() {
    ...
    79: [function(e, t, r) {
        ...
        }, l.cancelXHR = function() {}, l.destroy = function() {
    ...
    82: [function(e, t, r) {
        ...
        var i, a = e("@marcom/ac-shared-instance").SharedInstance,
            o = e("@marcom/ac-window-delegate").WindowDelegate,
    ...
    89: [function(e, t, r) {
        ...
        var n = e("../../WindowDelegateOptimizer"),
            ...
            o = new n(a, function(e) {
                var t, r = a.propertyNames,
                    n = r.length;
                for (t = 0; t < n; t++) this.update(r[t], i[r[t]](!0))
            });
        t.exports = o
    }, {
        "../../WindowDelegateOptimizer": 88,
        "../../queries/queries": 100
    }],
    90: [function(e, t, r) {
        "use strict";
            ...
            m = function(e) {
                ...
                return a(t, e), o(t, [{
                    ...
                    value: function() {
                        ...
                        for (var r = 0; r < t.length; r++)
                            for (var n = t[r], i = document.querySelectorAll("[" + n + "]"), a = 0; a < i.length; a++) {
                                var o = i[a],
                    ...
                    value: function() {
                        ...
                        j.update(function() {
                            ...
                            for (var o = 0, s = e.groups.length; o < s; o++) e.groups[o].forceUpdate({
                                waitForNextUpdate: !1
                            });
                ...
                return a(t, e), o(t, [{
                    ...
                    value: function(e) {
                        ...
                        if (0 !== s.length) {
                            ...
                            if (0 !== p.length)
                                if (this.needsWrite = !0, this._ownerIsElement) j.external(function() {
        ...
        var d = function T(e) {
            ...
            x = function() {
                function e(t) {
                    ...
                    for (var r = void 0;
                        (r = this.getNextToken()) && r !== j.EOF;) this.tokens.push(r);
                    this.tokens.push(r)
                }
                return o(e, [{
                    key: "advance",
            ...
            k = function() {
                ...
                return o(e, [{
                    ...
                    key: "unit",
                    value: function() {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : h.ANY_UNIT,
                            t = this.currentToken;
                ...
                return a(t, e), o(t, [{
                    ...
                    value: function() {
                        ...
                        for (var t = 0; t < e.length; t++)
                            for (var r = e[t], n = r.getAttribute("data-component-list"), i = n.split(" "), a = 0, o = i.length; a < o; a++) {
                                var s = i[a];
                                "" !== s && " " !== s && this.addComponent({
                                    el: r,
                                    componentName: s
                                })
                            }
    ...
    122: [function(e, t, r) {
        ...
        var n = {
            ...
            m = function(e, t) {
                ...
                if (i.dot(A[0], T) < 0)
                    for (j = 0; j < 3; j++) p[j] *= -1, A[j][0] *= -1, A[j][1] *= -1, A[j][2] *= -1;
                ...
                if (i && e(), a.push(e), !n) {
                    ...
                    var r = document.documentElement.scrollHeight,
                        ...
                        s = function p() {
                            ...
                            if (r !== e) o = 0;
                            else if (o++, o >= t.NUMBER_OF_FRAMES_TO_WAIT) return void a.forEach(function(e) {
                                return e()
                            });
    ...
    127: [function(e, t, r) {
        ...
        function a(e, t, r) {
            for (var n, a, o = e.length, s = 0; s < o; s++)
                if ("function" == typeof e[s].test ? e[s].test(r) === !0 && (n = e[s].name) : r.ua.indexOf(e[s].userAgent) > -1 && (n = e[s].name), n) {
    ...
    135: [function(e, t, r) {
        ...
        var n = "EventEmitter:propagation",
            ...
            s = function(e, t) {
                ...
                if ("object" == typeof r)
                    for (var a in r) t.call(this, a, r[a], i);
                "string" == typeof r && (r = r.split(" "), r.forEach(function(e) {
                    t.call(this, e, n, i)
                }, this))
            },
    ...
    140: [function(e, t, r) {
        ...
        function n(e, t, r) {
            ...
            for (i = 0; i < o; ++i)
                for (n = 0; n < a; ++n) g = u, u = e[n], 0 === n ? c.push(["d", i, "s", n, "=t", i, "p", u].join("")) : c.push(["d", i, "s", n, "=(t", i, "p", u, "-s", g, "*t", i, "p", g, ")"].join(""));
    ...
    141: [function(e, t, r) {
        ...
        function n(e) {
            ...
            for (var a = [], o = [], s = [
                ...
                ], p = [], c = [], u = 0; u < e.arrayArgs.length; ++u) {
                var g = e.arrayArgs[u];
    ...
    143: [function(e, t, r) {
        ...
        l.bind = function() {
            ...
            if ("number" != typeof t && (t = -1), this.bind(), "object" == typeof e && "undefined" != typeof e.shape) {
                ...
                if (r === e.dtype && o(e.shape, e.stride)) 0 === e.offset && e.data.length === e.shape[0] ? this.length = i(this.gl, this.type, this.length, this.usage, e.data, t) : this.length = i(this.gl, this.type, this.length, this.usage, e.data.subarray(e.offset, e.shape[0]), t);
                else {
    ...
    155: [function(e, t, r) {
        ...
        "./lib/create-attributes": 152,
        "./lib/create-uniforms": 153,
        "./lib/reflect": 154
    }],
    156: [function(e, t, r) {
        "use strict";
        ...
        function p(e, t, r, n, i, a, o, p) {
            ...
            var m = 1;
            if (2 === u.length) l = e.LUMINANCE, u = [u[0], u[1], 1], p = f(p.data, u, [p.stride[0], p.stride[1], 1], p.offset);
            else {
        ...
        function l(e, t) {
            ...
            var u = 0;
            if (2 === n.length) u = e.LUMINANCE, n = [n[0], n[1], 1], t = f(t.data, n, [t.stride[0], t.stride[1], 1], t.offset);
            else {
            ...
            var g, l, h = t.size;
            if (a) g = 0 === t.offset && t.data.length === h ? t.data : t.data.subarray(t.offset, t.offset + h);
            else {
                var m = [n[2], n[2] * n[0], 1];
                l = d.malloc(h, r);
                var v = f(l, n, m, 0);
    ...
    160: [function(e, t, r) {
        ...
        "./lib/vao-emulated.js": 158,
        "./lib/vao-native.js": 159
    }],
    161: [function(e, t, r) {
        function n() {
                    ...
                    value: function(e) {
                        if (e.parentElement._animInfo) {
                            var t = this.anim.getControllerForTarget(e.parentElement),
                                ...
                                n = p.parse(r.jsonProps.start + " + 25vh", {
                                    anchors: [r.anchors[0]]
                                });
                ...
                function t(e) {
                    ...
                    return r.basePath = e.basePath, r.buckets = e.buckets, r.numPadding = e.numPadding, r.images = [], r.imagesLeftToLoad = [], r.currentFrameIndicator = [], r.currentBucket = 0, r.stopLoading = !1, r.buckets.forEach(function(e) {
                        ...
                        Object.defineProperties(e, {
                            ...
                            numImagesStage1: {
                                value: Math.round(.75 * e.numImages),
                                writable: !1
                            }
        ...
        var o = function() {
            ...
            p = function(e) {
                ...
                return a(t, e), o(t, [{
                    ...
                    value: function() {
                        var e = this,
                            t = this.gum.getComponentOfType("CopyMagic", this.el.querySelector(".copy-scroll-container"));
            ...
            _ = function() {
                try {
                    var e = document.createElement("canvas"),
                        t = u.os.osx && u.os.version.minor < 14 ? e.getContext("webgl") : e.getContext("webgl", {
                            powerPreference: y
                        }),
                ...
                return o(t, e), p(t, [{
                    ...
                    value: function(e, t) {
                        ...
                        7 === e && (this.anim.addKeyframe(this.imageSequences[e].canvas, {
                            start: "a0t + " + t[0].end + "vh + 170vh",
                            end: "a0t + " + t[0].end + "vh + 180vh",
                            opacity: [1, .3],
                            anchors: [this.el],
                            breakpointMask: "XLM"
                        }), this.anim.addKeyframe(this.imageSequences[e].canvas, {
                    ...
                    value: function() {
                        f.section.options.dataAttribute = "analytics-fallback-section-engagement", j(f.section), f.analytics.passiveTracker({
                            eVar70: "fallback"
                        }, {
                    ...
                    value: function() {
                        ...
                        }), this.anim.remove()["catch"](function(e) {}), this.initiateFallbackTracking()
                    }
                }, {
                    key: "onBreakpointChange",
                    value: function(e) {
    ...
    186: [function(e, t, r) {
        ...
        "./../waves/fragShader": 197,
        "@marcom/ac-shader-player-2d": 69
    }],
    187: [function(e, t, r) {
        "use strict";
                ...
                return a(t, e), o(t, [{
                    ...
                    value: function() {
                        ...
                        for (var t = 2; t < e; t++)
                            if (t !== e - 2) {
                                var r = 0;
                                t === e - 1 && (r = 1), this.addKeyframe({
                                    el: this.screens[t - 1 - r],
                        ...
                        var n = this.anim.getControllerForTarget(this.copyMagic.copyEls[e - 1]),
                            i = n.getNearestKeyframeForAttribute("opacity", 1);
                        i.remove();
                        var a = n.getNearestKeyframeForAttribute(".active");
                        a.overwriteProps({
                            start: a.jsonProps.start,
                            end: a.jsonProps.start
                        })
                    }
                }], [{
                    key: "IS_SUPPORTED",
        ...
        var o = function() {
            ...
            g = function(e) {
                ...
                return a(t, e), o(t, [{
                    ...
                    value: function() {
                        var e = this;
                        this.playPauseButton.classList.add("playing"), this.playPauseButton.classList.add("icon-pausecircle"), this.playPauseButton.classList.remove("icon-playcircle"), u(function() {
                            e.playPauseButton.setAttribute("data-analytics-title", "pause | wave animation"), e.playPauseButton.setAttribute("data-analytics-click", "prop3:pause | wave animation")
                        })
                    }
                }, {
                    ...
                    value: function() {
                        var e = this;
                        this.playPauseButton.classList.remove("icon-pausecircle"), this.playPauseButton.classList.add("icon-playcircle"), u(function() {
                            e.playPauseButton.setAttribute("data-analytics-title", "play | wave animation"), e.playPauseButton.setAttribute("data-analytics-click", "prop3:play | wave animation")
                        })
                    }
                }, {
                    key: "handleControl",
    ...
    191: [function(e, t, r) {
        ...
        function i() {
            ...
            setTimeout(function() {
                try {
                    document.querySelector(".page-overview .modal").classList.add("theme-dark")
                } catch (e) {}
    ...
    192: [function(e, t, r) {
        ...
        "./initializeNormalSectionEngagement": 194,
