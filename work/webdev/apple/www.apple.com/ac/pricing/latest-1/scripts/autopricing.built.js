    ...
    return function(t) {
        ...
        t.exports = function(t) {
            return new Promise(e => {
                "undefined" != typeof window && window.document ? r(() => {
                    const i = {};
                    s(t) && (i.endpoint = (s(t).getAttribute("href") || "").trim()), n(t, i);
        ...
        t.exports = class extends n {
            ...
            formatResponseItem(t, e) {
                let i = null;
                return this.options.dummyPrices && "UNKNOWN" === e.type && (e = r(t, "unknown"), this.itemsWithDummyPrice.push(t)), i = new s(e), i.price && 999999 === i.price.value && this.itemsWithDummyPrice.push(t), i
            }
        ...
        "use strict";
        const r = i(1),
            s = "www.apple.com" === window.location.host || "www.apple.com.cn" === window.location.host,
            n = {
        ...
        t.exports = class {
            ...
            _request() {
                return new Promise((t, e) => {
                    ...
                    i.withCredentials = !0, i.onloadend = t.bind(this, i), i.ontimeout = e.bind(this, new o.TimeoutError(this.options.timeout)), i.onerror = e.bind(this, new o.UnexpectedError), i.open("POST", s(this.options.endpoint, this.identifierParam, this.ids), !0), i.timeout = 1e3 * (this.options.timeout || 0), i.send()
                })
            }
        }
    }, function(t, e, i) {
        "use strict";
        t.exports = {
            ConfigurationError: i(59),
            ServiceNotFoundError: i(60),
            ServiceUnavailableError: i(61),
            TimeoutError: i(62),
            InvalidDataError: i(4),
            UnexpectedError: i(63)
        }
    }, function(t, e, i) {
        "use strict";
        const r = i(2),
        ...
        t.exports = new class {
            ...
            checkForSingleElementIDs(t, e, i, r) {
                const s = r.dataset[`${t}${c}`],
                    n = i.products[s];
                s === this.getproductID(e, t) && (n && !this.checkForProductNameKey(n, n.productName) && !this.checkForTypeKey(n, n.type) || e.innerText || (r.style.display = "none"))
            }
            hideSingleElements(t, e, i) {
                this[`${i}${p}`].forEach(r => {
                    const s = r.dataset[`${i}${c}`],
                        n = e.products[s];
                    (e.error || !n || this.checkForProductNameKey(n, n.productName) || this.checkForTypeKey(n, n.type)) && this.checkForSingleElementIDs(i, t, e, r)
                })
            }
            ...
            fetchProductDataFromHTML(t, e) {
                return new Promise(i => {
                    this.setElements(t), this.fetchProductInfo(t, e).then(({
                        ...
                        this[`${t}${o}`].forEach(i => this.handleProductInfo(t, i, e, r)), i(e.error)
                    }).catch(t => {
                        throw t
                    })
                })
        ...
        "use strict";
        var r, s = i(30).EventEmitterMicro,
            n = i(31),
            a = i(34);
        ...
        "use strict";
        var r = i(7).SharedInstance,
            s = i(8).majorVersionNumber,
            n = i(33);
        ...
        t.exports = class extends s {
            constructor(t, e) {
                super(t, e), this.identifierParam = {
                    ids: "ids",
                    slugs: "slugs"
                }
            }
            ...
            formatResponseItem(t, e) {
                let i = null;
                return this.options.dummyPrices && "UNKNOWN" === e.productName && (e = r(t, "unknown"), this.itemsWithDummyPrice.push(t)), i = new n(e), 999999 === i.credit.value && this.itemsWithDummyPrice.push(t), i
            }
            getItemsFromResponse(t) {
                return t.ids
            }
